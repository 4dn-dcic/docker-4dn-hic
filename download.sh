...
python get_cwl.py -a hi-c-processing-partb -r 43 -t $SBG_TOKEN
...
python get_cwl.py -a merge-pairs -r 29 -t $SBG_TOKEN
python get_cwl.py -a pairs2hic -r 17 -t $SBG_TOKEN
python get_cwl.py -a cooler -r 23 -t $SBG_TOKEN
