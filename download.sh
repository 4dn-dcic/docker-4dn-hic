...
python get_cwl.py -a hi-c-processing-partb -r 6 -t $SBG_TOKEN
...
python get_cwl.py -a md5 -r 1 -t $SBG_TOKEN
python get_cwl.py -a merge-pairs -r 13 -t $SBG_TOKEN
python get_cwl.py -a bam2pairs -r 2 -t $SBG_TOKEN
python get_cwl.py -a sort-bam -r 3 -t $SBG_TOKEN
python get_cwl.py -a fastqc-0-11-4 -r 1 -t $SBG_TOKEN
python get_cwl.py -a FastQC -r 0 -t $SBG_TOKEN
