{baseCommand: [run-cool2multirescool.sh], hints: [{dockerPull: 'duplexa/4dn-hic:v17',
    ...
    {default: out, inputBinding: {separate: true, position: 3}, id: '#outprefix',
      type: ['null', string]}], requirements: [{class: InlineJavascriptRequirement}],
  class: CommandLineTool, arguments: [], outputs: [{outputBinding: {glob: '*.multires.cool
          *.mcool'}, id: '#output_mcool', type: ['null', File]}]}
