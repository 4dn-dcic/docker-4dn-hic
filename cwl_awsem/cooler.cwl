{baseCommand: [run-cooler.sh], inputs: [{type: ['null', File], inputBinding: {separate: true,
        position: 1}, secondaryFiles: [$(self.basename + '.px2')], id: '#pairs'},
    {type: ['null', File], inputBinding: {separate: true, position: 2}, id: '#chrsizes'},
    {type: ['null', int], inputBinding: {separate: true, position: 3}, id: '#binsize'},
    {default: out, type: ['null', string], inputBinding: {separate: true, position: 5},
