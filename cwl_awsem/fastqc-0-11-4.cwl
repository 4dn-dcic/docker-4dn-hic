{hints: [{class: DockerRequirement, dockerPull: 'duplexa/4dn-hic:v37'}], baseCommand: [
    run-fastqc.sh], class: CommandLineTool, inputs: [{type: [File], id: '#input_fastq',
      inputBinding: {position: 1, separate: true, itemSeparator: !!null ''}}, {type: [
