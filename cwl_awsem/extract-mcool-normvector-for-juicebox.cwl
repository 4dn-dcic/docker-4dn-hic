{arguments: [], outputs: [{id: '#output_normvector', outputBinding: {glob: '''*.juicerformat.gz'''},
      type: ['null', File]}], inputs: [{id: '#input_mcool', inputBinding: {separate: true,
        position: 1}, type: ['null', File]}, {default: ., id: '#outdir', inputBinding: {
