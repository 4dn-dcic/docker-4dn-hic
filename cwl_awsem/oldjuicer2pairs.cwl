{requirements: [{class: InlineJavascriptRequirement}], baseCommand: [old_merged_nodup2pairs.pl],
  ...
  cwlVersion: draft-3, class: CommandLineTool, outputs: [{outputBinding: {glob: '*.bsorted.pairs.gz'},
      ...
      id: '#out_pairs_px', type: ['null', File]}], inputs: [{inputBinding: {position: 3,
        ...
        position: 4, separate: true}, id: '#chromsize', type: ['null', File]}, {inputBinding: {
        position: 1, separate: true, prefix: -s}, id: '#nsplit', type: ['null', int],
      default: 100}, {inputBinding: {position: 5, separate: true}, id: '#outprefix',
      type: ['null', string], default: out}, {inputBinding: {position: 2, separate: true,
        prefix: -m}, id: '#max_remove_mapq', type: ['null', int]}]}
